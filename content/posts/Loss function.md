...
![Loss](static/imgs/imgs/loss_function.png)
...
- **MAE(Mean Absolute Error)** — $\left|정답 - 예측값\right|$의 평균
    ...
    ![Loss_function](static/imgs/imgs/loss_function1.png)
- **MSE(Mean Squared Error)** — $(정답 - 예측값)^2$의 평균
    ...
    ![Loss_function](static/imgs/imgs/loss_function2.png)
...
- **RMSE(Root MSE)** — $\sqrt{(정답 - 예측값)^2\text {의 평}균}$
    ...
    ![Loss_function](static/imgs/imgs/loss_function3.png)
    
    MSE와 마찬가지로 각 오차값의 크기에 따라 다른 그래디언트를 가지게 된다.
    

![Loss_function](static/imgs/imgs/loss_function4.png)
