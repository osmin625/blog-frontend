...
![Alt text](static/imgs/polynomial_interpolation.png)
...
![Alt text](static/imgs/polynomial_interpolation1.png)
...
- **Runge 현상**
    ...
    ![Alt text](static/imgs/polynomial_interpolation3.png)
    
    
- **Gibbs 현상**
    불연속 함수를 근사할 때 불연속 값 근처에서 나타나는 불일치 현상
    ![Alt text](static/imgs/polynomial_interpolation4.png)
    
![Alt text](static/imgs/polynomial_interpolation4-1.png)

### Piecewise Polynomials Interpolation

여러 개의 데이터를 하나의 추정 함수로 표현하지 않고, 구간 별로 추정 함수를 구하는 것

![Alt text](static/imgs/polynomial_interpolation5.png)
...
![Alt text](static/imgs/polynomial_interpolation6.png)
